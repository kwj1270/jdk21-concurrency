...
public class FsmCpsCalculator {
    ...
    public void calculate(final int initialValue, final Continuation<Integer> continuation) {
    ...
    private CustomContinuation<Integer> crateContinuation(final Continuation<Integer> continuation) {
        if (continuation instanceof CustomContinuation) {
